  ...
  return (
    <div className="relative container mx-auto py-5 p-1">
      <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
        ...
        <p className="mb-4">
          At <strong>Indo Zestfusion Cafe</strong> (
          <a
          ...
          ), we take your privacy seriously. This page explains how we collect,
        ...
        <p className="mb-4">
          We only collect information necessary for processing your order:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>Email address</li>
          <li>Order details</li>
          <li>
            <strong>Address</strong> (for delivery or pickup)
          </li>
        </ul>
        ...
        <p className="mb-4">
          We may occasionally send you exclusive offers via email. You can opt
          out anytime:
        </p>
        <ul className="list-disc list-inside mb-4">
        ...
        <p className="mb-4">
          We <strong>do not sell or share your data</strong> with any third
      ...
      <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          personal data at any time. Please contact  :00
        </p>
        <p className="mb-4">
