      ...
      <div className="container mx-auto py-5 p-1">
        <div className="max-w-xl mx-auto mt-20 text-center">
          ...
          <p className="text-sm text-gray-500">
            ...
            <a href="mailto:info@indozestfusioncafe-gf.de" className="underline">
              info@indozestfusioncafe-gf.de
            </a>.
          </p>
        </div>
      </div>
  ...
  return (
    ...
    <div className="container mx-auto py-5 p-1">
      <div className="max-w-xl mx-auto mt-20 p-6 text-center border rounded-lg shadow-sm bg-white">
        ...
        <p className="text-gray-700 mb-6">Are you sure you want to unsubscribe from indozestfusioncafe Taste Of India?</p>
